...
List<Map> links = [
  {
    'name': 'ايه المشكله',
    'url': 'https://youtu.be/qHXCBBBXes4?si=xfB6LnKqQ3-x_z4p',
  },
  {
    'name': 'ليله رمضان',
  ...
  },
  {
    'name': 'السيره النبويه',
    'url':
        'https://youtube.com/playlist?list=PLSSxr3Rf2_X2oKwiy4UhzIdj4ACzB6dee&si=OO2q7XI3fAZH2qn7',
  },
  {
    'name': 'اصحاب رسول الله',
    'url':
        'https://youtube.com/playlist?list=PLSSxr3Rf2_X1KkCTVpfCVEVcoY16ACSuf&si=UCn3TfmhihsSwADl',
  },
  {
    'name': 'رحله الي الدار الاخره',
    'url':
        'https://youtube.com/playlist?list=PLSSxr3Rf2_X1QNGSYhHRVM4xW9_CWQe4B&si=lvbCVLfaRVpyxhCr',
  },
  {
    'name': 'قصص السنه',
    'url':
        'https://youtube.com/playlist?list=PLSSxr3Rf2_X3N6l7ZB48N1_hKh9XEtpOt&si=fKQWhr2hcH89VJXz',
  },
  {
    'name': 'قصص القران',
    'url':
        'https://youtube.com/playlist?list=PLSSxr3Rf2_X09k084XozCL-GIIil-lC4V&si=UGCCONWxEV5pSxky',
  },
  {
    'name': 'قصص الكهف',
    'url':
